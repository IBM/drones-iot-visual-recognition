...
This hands on lab uses drone aerial images, Watson Studio and Watson Visual Recognition to survey flood damaged neighborhoods and identify homes with survivors on rooftops
...
- Aerial drone images of suburban neighborhoods to be used for the negative class - [suburban-neighborhood.zip](classes/suburban-neighborhood.zip)
...
- Create another class *Survivors* - drag a zipfile
